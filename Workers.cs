    ...
    public partial class Workers : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                For.InsertCommand.Parameters.Add(new SqlParameter("@id_post", SqlDbType.Int, 0, "id_post"));
                For.InsertCommand.Parameters.Add(new SqlParameter("@id_departent", SqlDbType.Int, 0, "id_departent"));
