    ...
    public partial class Acts : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                For.InsertCommand = new SqlCommand(" dbo_Act", connection);
                For.InsertCommand.CommandType = CommandType.StoredProcedure;
                For.InsertCommand.Parameters.Add(new SqlParameter("@id_workers", SqlDbType.Int, 0, "id_workers"));
                For.InsertCommand.Parameters.Add(new SqlParameter("@id_strucure", SqlDbType.Int, 0, "id_strucure"));
                For.InsertCommand.Parameters.Add(new SqlParameter("@date_act", SqlDbType.VarChar, 30, "date_act"));
