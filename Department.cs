...
namespace Zags
{
    ...
    private void Department_Load(object sender, EventArgs e)
        ...
        {
            openchild(panel1, new Department());
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                For.InsertCommand = new SqlCommand("dbo_Department", connection);
                For.InsertCommand.CommandType = CommandType.StoredProcedure;
                For.InsertCommand.Parameters.Add(new SqlParameter("@naem_department", SqlDbType.VarChar, 60, "naem_department"));
