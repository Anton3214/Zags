    ...
    public partial class Type : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                For.InsertCommand = new SqlCommand("dbo_Typa", connection);
                For.InsertCommand.CommandType = CommandType.StoredProcedure;
                For.InsertCommand.Parameters.Add(new SqlParameter("@name_services", SqlDbType.VarChar, 50, "name_services"));
